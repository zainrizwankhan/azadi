...
HD_PWD='/home/merl/github_repos/azadi/fpga/debug/debug.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log azadi_top_arty7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source azadi_top_arty7.tcl
