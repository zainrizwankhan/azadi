...
HD_PWD='/home/merl/github_repos/azadi/fpga/debug/debug.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log azadi_top_arty7.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source azadi_top_arty7.tcl -notrace
