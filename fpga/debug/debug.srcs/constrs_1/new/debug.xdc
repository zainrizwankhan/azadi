...
#set_property  CLOCK_DEDICATED_ROUT FALSE [get_nets{jtag_tck_i_IBUF}];
...
#set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { jtag_tck_i }]; #IO_0_15 Sch=ja[1]
...
#set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { jtag_tck_i }]; #IO_L11N_T1_SRCC_35 Sch=jd[1]
...
#set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { jtag_tck_i }]; #IO_L13N_T2_MRCC_35 Sch=jd[4]
